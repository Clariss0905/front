  ...
  <el-container style="height: 720px; border: 1px solid #eee">
    <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
      <el-menu :default-openeds="['1', '3']">
        ...
        <el-submenu index="2">
          <template slot="title"
            ><i class="el-icon-reading"></i>成绩录入</template
          >
          <el-menu-item-group>
        ...
        <el-submenu index="3">
          ...
          >
          <el-menu-item-group>
            <el-menu-item index="3-1" @click="toApply()"
              >奖惩申请</el-menu-item
            >
          </el-menu-item-group>
        </el-submenu>
    ...
    <el-container>
      <el-header style="text-align: right; font-size: 12px">
        <span style="text-align: left">欢迎登录评奖评优系统教师端</span>
        <el-dropdown>
...
export default {
  ...
  methods: {
    ...
    toInfo() {
      var id = this.uid;
      // 跳转用户信息页面
      this.$router.push({ path: "/teacherinfo", query: { id: id } });
    },
    toCourse() {
      var id = this.uid;
      // 跳转用户信息页面
      this.$router.push({ path: "/teacherclassgrade", query: { id: id } });
    },
    toApply() {
      var id = this.uid;
      // 跳转用户信息页面
      this.$router.push({ path: "/teacherapplyaward", query: { id: id } });
    },
  },
};
</script>